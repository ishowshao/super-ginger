...
Food.prototype._shake = function () {
    this.shaking = this.game.add.tween(this.image).to({ y: '8' }, 1500, Phaser.Easing.Sinusoidal.InOut, true, 0, -1, true);
};
...
Food.prototype.beEaten = function () {
    ...
    var vanish = this.game.add.tween(image.scale).to({
        x: 0,
        y: 0
