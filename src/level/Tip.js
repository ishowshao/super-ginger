...
Tip.prototype._init = function () {
    var game = this.game;
    var textText = game.add.text(game.width / 2, 135, this.text, {
...
Tip.prototype._show = function () {
    this.game.add.tween(this.textText).from({ alpha: 0 }, 300, Phaser.Easing.Quadratic.Out, true);
};
Tip.prototype.hide = function () {
    var hide = this.game.add.tween(this.textText).to({ alpha: 0 }, 300, Phaser.Easing.Quadratic.In);
