...
Confirm.prototype._initText = function () {
    ...
    var textText = game.add.text(this.containerWidth / 2, 40, this.text, {
...
Confirm.prototype._initBtns = function () {
    ...
    var container = this.container;
    var margin = 25;
    var btnConfirm = game.add.button(this.containerWidth / 2 + margin, this.containerHeight, 'btn-confirm', function () {
        this.onConfirm();
        this._hide();
    }, this);
    ...
    var btnCancel = game.add.button(this.containerWidth / 2 - margin - btnConfirm.width, this.containerHeight, 'btn-confirm', function () {
        this._hide();
    }, this);
    ...
    var confirmText = game.add.text(btnConfirm.width / 2, -btnConfirm.height / 2, '是', fontStyle);
    confirmText.anchor.set(0.5);
    btnConfirm.addChild(confirmText);
    var cancelText = game.add.text(btnCancel.width / 2, -btnCancel.height / 2, '否', fontStyle);
